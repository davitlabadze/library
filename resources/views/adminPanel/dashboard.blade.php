...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-4">
    <div class="relative flex items-center px-6 py-5 space-x-3 bg-red-500 border rounded-lg shadow-sm hover:bg-red-600">
        <div class="flex-shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-6 h-6 mr-3 text-white" fill="none"
    ...
    <div
        class="relative flex items-center px-6 py-5 space-x-3 bg-blue-500 border rounded-lg shadow-sm hover:bg-blue-600">
        <div class="flex-shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-6 h-6 mr-3 text-white " fill="none"
                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
...
<div class="flex py-3 mt-10 ">
    <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-6 h-6 mr-3 text-black " fill="none"
...
<table class="min-w-full divide-y divide-gray-200 ">
    ...
    <tbody
        class="flex flex-col items-center w-full overflow-x-hidden overflow-y-scroll text-center bg-white dark:bg-slate-800 rounded-b-md h-96">
